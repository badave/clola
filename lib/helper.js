 ...
 * JSON Web Token
 */
helper.randomHash = function(algorithm) {
  algorithm = algorithm || 'sha256'; // default to sha256
  var data = uuid.v4();
...
helper.encodeJwt = function(payload, secret) {
  return jwt.encode(payload, secret);
};

helper.decodeJwt = function(token, secret) {
